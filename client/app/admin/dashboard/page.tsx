...
import {
    ...
    DollarLinear as DollarSign,
    BagLinear as ShoppingBag,
    UsersGroupRoundedLinear as Users,
    GraphUpLinear as TrendingUp,
    AltArrowUpLinear as ArrowUpRight,
    DangerCircleLinear as AlertCircle,
                            ...
                            <BarChart data={stats.dailySalesData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                ...
                                <Tooltip
                                    ...
                                    formatter={(value) => {
                                        ...
                                        return [formatPriceLabel(Number.isFinite(amount) ? amount : 0), "فروش"];
                                    }}
                                />
                                <Bar
                                    dataKey="فروش"
